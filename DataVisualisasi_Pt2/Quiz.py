...
# Scatter matrix plot adalah plot yang digunakan
# untuk membuat sekumpulan scatter plot dari beberapa pasang variabel.
# Hal ini sangat bermanfaat terutama ketika ingin menganalisis bagaimana bentuk hubungan antar variabel.
# Plot ini sangat bermanfaat untuk digunakan untuk data yang ukurannya tidak terlalu besar.

# Untuk menggunakan scatter matrix kita harus memanggil fungsi scatter_matrix dari pandas.plotting.

# Perhatikan bahwa diagonal dari scatter matriks adalah histogram dari masing-masing variabel,
# sedangkan sisanya adalah scatter plot dari beberapa pasang variabel.
...
# Lengkapilah kode pada konsil untuk mengubah diagonal dari scatter matrix menjadi density plot.
